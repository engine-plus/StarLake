...
object StarLakeErrors {
  ...
  def specifySchemaAtReadTimeException: Throwable = {
    new AnalysisException("Star does not support specifying the schema at read time.")
  }
  ...
  def streamWriteNullTypeException: Throwable = {
    new AnalysisException(
      "Star Lake doesn't accept NullTypes in the schema for streaming writes.")
  }
  ...
  def illegalStarLakeOptionException(name: String, input: String, explain: String): Throwable = {
  ...
  def modifyAppendOnlyTableException: Throwable = {
    new UnsupportedOperationException(
      "This table is configured to only allow appends. If you would like to permit " +
        ...
        s"(${StarLakeConfig.IS_APPEND_ONLY.key}=false)'.")
  }
  ...
  def notAnStarLakeSourceException(command: String, plan: Option[LogicalPlan] = None): Throwable = {
    ...
    new AnalysisException(s"$command destination only supports star sources.\n$planName")
  }
  ...
  def illegalUsageException(option: String, operation: String): Throwable = {
    throw new IllegalArgumentException(
      s"The usage of $option is not allowed when $operation a Star table.")
  }
  ...
  def createExternalTableWithoutSchemaException(path: Path, tableName: String): Throwable = {
    new AnalysisException(
      s"""
         ...
         |from `$path` using StarLake, but the schema is not specified.
       """.stripMargin)
  }
  ...
  def createManagedTableWithoutSchemaException(tableName: String): Throwable = {
    new AnalysisException(
      s"""
         ...
         |using StarLake, but the schema is not specified.
       """.stripMargin)
  }
  ...
  def operationNotSupportedException(operation: String): Throwable = {
    new AnalysisException(
      s"Operation not allowed: `$operation` is not supported for Star tables")
  }
  ...
  def operationNotSupportedException(operation: String, tableIdentifier: TableIdentifier): Throwable = {
    new AnalysisException(
      s"Operation not allowed: `$operation` is not supported " +
        s"for star tables: $tableIdentifier")
  }
  ...
  def schemaChangedSinceAnalysis(atAnalysis: StructType, latestSchema: StructType): Throwable = {
    ...
    new AnalysisException(
      s"""The schema of your Star table has changed in an incompatible way since your DataFrame or
         |StarLakeTable object was created. Please redefine your DataFrame or StarLakeTable object.
         |Changes:\n${schemaDiff.mkString("\n")}
       """.stripMargin)
  }
  ...
  def configureSparkSessionWithExtensionAndCatalog(originalException: Throwable): Throwable = {
    ...
    new AnalysisException(
      s"""This Star operation requires the SparkSession to be configured with the
         |StarSparkSessionExtension and the StarLakeCatalog. Please set the necessary
         |configurations when creating the SparkSession as shown below.
         |
         |  SparkSession.builder()
         |    .option("spark.sql.extensions", "${classOf[StarSparkSessionExtension].getName}")
         |    .option("$catalogImplConfig", "${classOf[StarLakeCatalog].getName}"
         |    ...
         |    .build()
      """.stripMargin,
  ...
  def upsertConditionNotFoundException(): Throwable = {
    throw new AnalysisException(
      s"""
         ...
         |You can also set spark.engineplus.star.full.partitioned.table.scan.enabled to true,
         |or set spark.engineplus.star.deltaFile.enabled to true.
      """.stripMargin)
  }

  def starRelationIllegalException(): Throwable = {
    throw new AnalysisException(
      s"""
         |Relation type is illegal, only StarLakeTable should exists here.
      """.stripMargin)
  }
  ...
  def addSchemaMismatch(original: StructType, data: StructType): Unit = {
    bits ++=
      s"""A schema mismatch detected when writing to the table.
         ...
         |
         |Table schema:
         |${StarLakeErrors.formatSchema(original)}
         |
         |Data schema:
         |${StarLakeErrors.formatSchema(data)}
         """.stripMargin :: Nil
  ...
  def addPartitioningMismatch(original: Seq[String], provided: Seq[String]): Unit = {
    bits ++=
      s"""Partition columns do not match the partition columns of the table.
         |Given: ${StarLakeErrors.formatColumnList(provided)}
         |Table: ${StarLakeErrors.formatColumnList(original)}
         """.stripMargin :: Nil
  }
  ...
  def addOverwriteBit(): Unit = {
    bits ++=
      s"""To overwrite your data schema, please set:
         ...
         |'${StarLakeOptions.REPLACE_WHERE_OPTION}'.
         """.stripMargin :: Nil
    mentionedOption = true
  }
