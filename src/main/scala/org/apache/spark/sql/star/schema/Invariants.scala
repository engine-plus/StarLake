...
import org.apache.spark.sql.star.utils.JsonUtils
import org.apache.spark.sql.types.StructType

/**
  * List of invariants that can be defined on a StarTable that will allow us to perform
...
object Invariants {
  ...
  val INVARIANTS_FIELD = "star.invariants"
}
